...
![Banks](https://img.shields.io/badge/Banks%20Tracked-20-green)
...
![Dashboard Screenshot 5](images/dashboard5.png)
...
## ⚙️ Run Locally
```bash
git clone https://github.com/yourusername/pakistan-banking-stock-analytics
cd pakistan-banking-stock-analytics
